...
Vui lòng liên hệ và hỗ trợ cấp cứu ngay lập tức!`;
  ...
  return (
    <div className="space-y-5">
      ...
      {/* DUAL-ENGINE PARALLEL SOS MODE INDICATOR BANNER */}
      <div className="bg-gradient-to-r from-emerald-50 via-amber-50 to-red-50 p-4 sm:p-5 rounded-2xl border border-amber-200 shadow-sm space-y-3">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-amber-200/60 pb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-black text-slate-900 text-sm sm:text-base">
              HỆ THỐNG CỨU HỘ KÉP: TỰ ĐỘNG NGẦM & THỦ CÔNG SONG SONG
            </h3>
          </div>
          <span className="px-2.5 py-0.5 bg-amber-100 text-amber-800 font-mono font-extrabold text-[11px] rounded-full border border-amber-300">
            CHẾ ĐỘ SONG SONG 24/7
          </span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
          {/* Engine 1: Automatic Engine */}
          <div className="bg-white p-3.5 rounded-xl border border-emerald-200 shadow-2xs space-y-2">
            <div className="flex items-center justify-between font-bold text-emerald-800">
              <span className="flex items-center gap-1.5">
                <Zap className="w-4 h-4 text-emerald-600" />
                1. ĐỘNG CƠ TỰ ĐỘNG NGẦM
              </span>
            ...
            <p className="text-slate-600 leading-relaxed text-[11px]">
              Tự động giám sát <strong>Gia tốc va chạm/Té ngã (DeviceMotion)</strong>, <strong>Âm thanh kêu cứu AI</strong> và tự động truyền tọa độ GPS/Mức pin về Firebase mỗi 5 phút. Không cần bạn phải thao tác.
            </p>
          </div>

          {/* Engine 2: Manual Engine */}
          <div className="bg-white p-3.5 rounded-xl border border-red-200 shadow-2xs space-y-2">
            ...
            <p className="text-slate-600 leading-relaxed text-[11px]">
              Bấm nút SOS cực đại bên dưới hoặc gọi trực tiếp 115/113/114 bất kỳ lúc nào bạn còn tỉnh táo. Cả hai động cơ chạy song song đảm bảo an toàn tuyệt đối.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-4 sm:p-5 rounded-2xl border border-red-200 shadow-sm space-y-3">
        <div className="flex items-center justify-between text-xs font-bold text-red-600">
          ...
          <span className="text-slate-500 font-normal">Miễn phí 24/7</span>
        </div>

        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          <a
            href="tel:115"
            className="flex flex-col items-center justify-center p-3 rounded-xl bg-gradient-to-b from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white shadow text-center active:scale-95 transition"
          >
          ...
          <a
            href="tel:113"
            className="flex flex-col items-center justify-center p-3 rounded-xl bg-gradient-to-b from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white shadow text-center active:scale-95 transition"
          >
          ...
          <a
            href="tel:114"
            className="flex flex-col items-center justify-center p-3 rounded-xl bg-gradient-to-b from-amber-600 to-amber-700 hover:from-amber-500 hover:to-amber-600 text-white shadow text-center active:scale-95 transition"
          >
      ...
      <div className="bg-white p-6 rounded-2xl border border-red-200 shadow-md relative overflow-hidden">
        <div className="absolute -right-12 -top-12 w-64 h-64 bg-red-100 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-4">
          ...
          <div className="relative group my-2">
            <div className="absolute -inset-4 bg-red-200 rounded-full blur-xl group-hover:bg-red-300 transition duration-500 animate-pulse" />
            <div className="absolute -inset-2 bg-red-100 rounded-full animate-ping" />

            <button
              onClick={() => onTriggerSosCountdown("Kích hoạt nút bấm SOS khẩn cấp")}
              className="relative w-48 h-48 sm:w-56 sm:h-56 rounded-full bg-gradient-to-b from-red-500 via-red-600 to-red-800 hover:from-red-600 hover:to-red-900 border-4 border-white text-white shadow-2xl shadow-red-600/40 flex flex-col items-center justify-center gap-2 transform active:scale-95 transition cursor-pointer select-none"
            >
              ...
              <span className="text-[10px] sm:text-xs font-extrabold text-white uppercase tracking-wider bg-black/30 px-3 py-1 rounded-full border border-white/20">
                BẤM CỨU HỘ NGAY
              </span>
            </button>
          </div>
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 space-y-3 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-100 pb-2.5">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-extrabold text-slate-900 text-sm">Vị Trí Cứu Hộ GPS Hiện Tại</h3>
          </div>

          <div className="flex items-center gap-2 text-xs">
            <span className={`px-2 py-0.5 rounded font-mono font-bold text-[10px] ${
              location.accuracy <= 15 ? "bg-emerald-50 text-emerald-700 border border-emerald-200" : "bg-amber-50 text-amber-700 border border-amber-200"
            }`}>
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-lg transition border border-emerald-200 font-bold text-xs"
            >
        ...
        {isEditingCustomAddress ? (
          <div className="space-y-2 pt-1">
            <label className="text-xs text-slate-700 font-semibold block">Nhập chi tiết địa chỉ hiện tại (Số nhà, Tầng, Điểm mốc):</label>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-slate-50 border border-slate-300 rounded-xl p-2.5 text-xs text-slate-900 focus:outline-none focus:border-amber-500"
              />
              <button
          ...
          <div className="space-y-2">
            <p className="text-slate-900 font-bold text-sm sm:text-base leading-snug bg-slate-50 p-3 rounded-xl border border-slate-200">
              {location.address}
            </p>

            <div className="flex flex-wrap items-center justify-between gap-2 text-xs text-slate-500 font-mono pt-1">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1 text-amber-600 hover:underline text-[11px] font-sans font-bold"
                >
                ...
                <a
                  ...
                  className="flex items-center gap-1 text-emerald-600 hover:underline text-[11px] font-sans font-bold"
                >
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 space-y-4 shadow-sm">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-extrabold text-slate-900 text-sm">Gửi Bản Tin SOS / Tọa Độ Khẩn Cấp</h3>
          </div>

          <span className="text-xs text-slate-500">1-Touch SMS Payload</span>
        </div>

        {/* Input Incident Note */}
        <div className="space-y-1">
          <label className="text-xs text-slate-600 block font-semibold">Tình trạng / Mô tả sự cố (nếu có):</label>
          <input
            type="text"
        ...
        <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 text-xs text-slate-800 font-mono leading-relaxed whitespace-pre-wrap">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
          <a
            ...
            className="flex items-center justify-center gap-2 py-3 px-4 bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs sm:text-sm rounded-xl transition shadow text-center"
          >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 py-3 px-4 bg-slate-100 hover:bg-slate-200 text-slate-800 font-bold text-xs sm:text-sm rounded-xl transition border border-slate-200"
          >
            {copiedMsg ? <CheckCircle2 className="w-4 h-4 text-emerald-600" /> : <Copy className="w-4 h-4" />}
      ...
      <div className="bg-white p-5 rounded-2xl border border-slate-200 space-y-3 text-xs shadow-sm">
        ...
        {userProfile.primaryRecipientPhone && (
          <div className="bg-slate-50 p-3.5 rounded-xl border border-amber-300 space-y-2">
            <div className="flex items-center justify-between">
              <div>
                <span className="font-extrabold text-slate-900 text-sm">
                  {userProfile.primaryRecipientName || "Người Nhận Cảnh Báo Chính"}
                </span>
                <span className="ml-2 text-[10px] bg-amber-100 text-amber-800 px-2 py-0.5 rounded font-bold border border-amber-300">
                  Liên hệ chính
                </span>
              </div>
              <span className="text-slate-800 font-mono font-bold">{userProfile.primaryRecipientPhone}</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              <a
                ...
                className="flex items-center justify-center gap-1.5 py-2.5 px-3 bg-emerald-600 hover:bg-emerald-500 text-white font-extrabold text-xs rounded-xl transition shadow active:scale-95 text-center"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-1.5 py-2.5 px-3 bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs rounded-xl transition shadow active:scale-95 text-center"
              >
        ...
        {userProfile.emergencyContacts.map((cnt) => (
          <div key={cnt.id} className="bg-slate-50 p-3.5 rounded-xl border border-slate-200 space-y-2">
            <div className="flex items-center justify-between">
              <div>
                <span className="font-extrabold text-slate-900 text-sm">{cnt.name}</span>
                <span className="ml-2 text-[11px] text-slate-500">({cnt.relationship})</span>
              </div>
              <span className="text-slate-800 font-mono font-bold">{cnt.phone}</span>
            </div>

            <div className="grid grid-cols-2 gap-2 pt-1">
              <a
                href={`tel:${cnt.phone}`}
                className="flex items-center justify-center gap-1.5 py-2 px-3 bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs rounded-xl transition active:scale-95 text-center"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-1.5 py-2 px-3 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-xl transition active:scale-95 text-center"
              >
        ...
        {!userProfile.primaryRecipientPhone && userProfile.emergencyContacts.length === 0 && (
          <div className="bg-amber-50 p-4 rounded-xl border border-amber-200 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <a
                href="tel:115"
                className="flex items-center justify-center gap-1.5 py-2.5 px-3 bg-red-600 hover:bg-red-500 text-white font-extrabold text-xs rounded-xl transition text-center shadow"
              >
                <PhoneCall className="w-4 h-4" />
              ...
              <a
                ...
                className="flex items-center justify-center gap-1.5 py-2.5 px-3 bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs rounded-xl transition text-center shadow"
              >
                <MessageSquare className="w-4 h-4" />
